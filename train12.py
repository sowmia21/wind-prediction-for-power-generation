...
def train(data_path, test_ratio=0.2, n_neighbors=5):
    ...
    model = KNeighborsRegressor(
        ...
        weights='uniform',  # can also use 'distance'
        metric='minkowski',  # default Euclidean distance
        p=2
    )

    print(f"Training KNN Regressor with {n_neighbors} neighbors...")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Train KNN Regressor on Wind Power Data")
