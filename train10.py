...
def train(data_path, test_ratio=0.2):
    ...
    # --- Step 5: Initialize AdaBoost Regressor ---
    ...
    rmse = mean_squared_error(y_test, y_pred) ** 0.5  # works in all sklearn versions
    ...
    # Optional: return model and scaler
    return model, scaler

if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Train AdaBoost on Wind Power Data")
    parser.add_argument('--data', type=str, required=True, help="Path to CSV dataset")
    parser.add_argument('--test_ratio', type=float, default=0.2, help="Test set ratio")
    args = parser.parse_args()

    # Handle quotes/spaces automatically
