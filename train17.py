...
def train(data_path):
    ...
    # Feature scaling is optional for CatBoost, but we can scale if needed
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Train CatBoost Regressor on Wind Power Data")
