...
def train(data_path):
    ...
    # Elastic Net Regressor with default parameters
    model = ElasticNet(alpha=1.0, l1_ratio=0.5, random_state=42)
    print("Training Elastic Net Regressor with default alpha=1.0, l1_ratio=0.5...")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Train Elastic Net Regressor on Wind Power Data")
